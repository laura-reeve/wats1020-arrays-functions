...
// 2. Use the length attribute to find the number of words in the Array
    var totalLength = longTextArray.length
// 3. Determine how many words should be removed from the String and insert ellipses
    var remove = totalLength - numWords;
// 4. Remove those words from the Array
    longTextArray.splice(numWords,remove);
// 5. Add an additional String item to the Array to put an ellipses in: "..." - use push
    longTextArray.push("..."); 
// 6. Use the join() function to convert the Array back into a String    
    var shortText = longTextArray.join(" ");
